...
const styles = {
  container: {
    ...
    border: `1px solid ${theme.colors.accent.microtask}44`,
  ...
  header: {
    ...
    borderBottom: `1px solid ${theme.colors.accent.microtask}44`,
  ...
  indicator: {
    ...
    height: '8px',
    borderRadius: '50%',
    backgroundColor: theme.colors.accent.microtask,
    boxShadow: `0 0 8px ${theme.colors.accent.microtask}`,
  },
  title: {
...
export const MicrotaskQueue: React.FC<MicrotaskQueueProps> = ({
  tasks,
  onTaskClick,
  onReorder,
}) => {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <h2 style={styles.title}>Microtask Queue</h2>
          <span style={styles.priority}>High Priority</span>
        </div>
        <span style={styles.count}>{tasks.length}</span>
      </div>
      <div style={styles.content}>
        {sortedTasks.length === 0 ? (
          <div style={styles.empty}>// No microtasks</div>
        ) : (
          <DndContext
            sensors={sensors}
